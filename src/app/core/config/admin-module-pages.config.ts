...
export const ADMIN_MODULE_PAGES: Record<string, AdminModulePageCopy> = {
  pacientes: {
    ...
    bannerSubtitle: 'Alta y ficha de mascotas. Ver expediente abre el historial clínico completo.',
    listTitle: 'Directorio',
    listDescription: 'Listado CRUD. El expediente (historial, vacunas, desparasitación) se abre desde el directorio.',
