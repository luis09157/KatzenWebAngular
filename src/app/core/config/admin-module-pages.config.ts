...
export const ADMIN_MODULE_PAGES: Record<string, AdminModulePageCopy> = {
  pacientes: {
    ...
    bannerSubtitle: 'Alta y ficha de mascotas. El expediente clínico se abre en Buscar paciente.',
    listTitle: 'Directorio',
    listDescription: 'Listado CRUD. Para ver historial y vacunas usa Buscar paciente.',
