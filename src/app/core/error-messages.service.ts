...
export class ErrorMessagesService {
  ...
  private static readonly FIREBASE_MESSAGES: Record<string, string> = {
    ...
    'failed-precondition':
      'No se pudo completar. Revisa los datos e inténtalo de nuevo. Si sigue fallando avisa a administración.',
    'invalid-argument':
      'Hay un dato que no cuadra. Revisa los campos e inténtalo de nuevo. Si sigue fallando avisa a administración.',
    'resource-exhausted': 'Demasiados intentos. Espera un momento e inténtalo de nuevo.',
    internal: 'Algo falló del lado del servidor. Inténtalo de nuevo. Si sigue fallando avisa a administración.',
    unknown:
      'Ocurrió un error inesperado. Revisa los datos e inténtalo de nuevo. Si sigue fallando avisa a administración.',
  };
  ...
  private static readonly FUNCTIONS_MESSAGES: Record<string, string> = {
    ...
    'functions/internal':
      'El servidor no pudo procesar la solicitud. Inténtalo de nuevo. Si sigue fallando avisa a administración.',
  };
  ...
  private static readonly CONTEXT_MESSAGES: Record<string, string> = {
    ...
    'eliminar historial': 'No se pudo borrar el historial clínico.',
    ...
    'eliminar vacuna': 'No se pudo borrar la vacuna.',
    ...
    'registrar ajuste':
      'No se pudo registrar el ajuste. Verifica que seas supervisor (administrador o veterinario) y que el motivo esté completo.',
    ...
    'devolver visita': 'No se pudo registrar la devolución.',
    'guardar corte de caja': 'No se pudo guardar el corte de caja.',
    ...
    'vincular portal dual': 'No se pudo vincular el portal de mascotas a esta persona.',
    'desvincular portal dual': 'No se pudo quitar el acceso al portal de mascotas.',
    ...
    'guardar configuración':
      'No se pudo guardar la configuración de la clínica. Revisa tu conexión e inténtalo de nuevo.',
  };
  ...
  getUserMessage(error: unknown, context?: string): string {
    ...
    if (err.code) {
      ...
      const firebaseMsg =
        ErrorMessagesService.FIREBASE_MESSAGES[err.code] || ErrorMessagesService.FIREBASE_MESSAGES[bareCode];
  ...
  private static extractCallableMessage(err: { code?: string; message?: string; details?: unknown }): string | null {
    ...
    const bareCode = String(err.code || '')
      .replace(/^functions\//, '')
      .toLowerCase();
  ...
  private getGenericMessage(context?: string): string {
    ...
    return 'Ocurrió un error. Revisa los datos e inténtalo de nuevo. Si sigue fallando avisa a administración.';
  }
}
