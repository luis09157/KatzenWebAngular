...
export const FUENTE_CORTA_DEFAULT =
  'Referencia CAPC/ESCCAP. El producto del lote y el criterio clínico mandan.';
export const FUENTE_CORTA_EXOTICO =
  'Intervalo manual. No copiamos el calendario de perro/gato.';
...
export const HINT_CACHORRO: HintDesparasitacion = {
  ...
  severity: 'info',
  message:
    'En cachorros/gatitos la serie típica es cada 2 semanas hasta ~12 semanas, luego mensual hasta los 6 meses.'
};
...
export const HINT_FALLECIDO: HintDesparasitacion = {
  key: 'fallecido',
  severity: 'warn',
  message: 'La mascota está Fallecido: se registrará sin próxima dosis (spec 017).'
};
