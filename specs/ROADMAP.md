...
| **Inventario** | Salida ligada a historial para medicamentos controlados; ~~política mermas~~ **Hecho (MVP 007)**; ~~Proveedores visibles en menú~~ **026** (`/admin/inventario/proveedores`) — autorización dual formal pendiente | Media |
