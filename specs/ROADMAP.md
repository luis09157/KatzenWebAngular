...
| **Portal / auth** | ~~Registro self-service landing~~ **013**; ~~UI perfil dual~~ **012**; ~~desvincular dual~~ **015**; ~~revocación sesiones~~ **hecho + deploy OK**; ~~query mascotas cliente_id~~ **020**; ~~portal baños~~ **028**; ~~interconexión + pensión/recordatorios portal~~ **031**; ~~**047** enlace portal↔ficha clínica (ola 1–2)~~ **done**; ola 3 teléfono diferida; **Cypress portal** guest + auth (skip sin env) | Alta |
...
| **Ops clínicas** | **033–037 done**. **052 olas 1–2 in_progress** (motor + confirmación + CONEJO + scheduler push + PWA portal; `specs/052-vacunas-esquemas-push-pwa/`). Ola 3 tipos conejo/hurón pendiente. Deploy functions-fcm scheduler **pendiente autorización Luis**. | Alta |
