...
| **Ops clínicas** | **033 done:** vacuna con `proximaAplicacion` → recordatorio automático (dedupe + cancelación al borrar vacuna) — `specs/033-vacuna-recordatorio-auto/`. Siguiente: alergias cruzadas, staff UID por acto, mejoras ticket. | Alta — **cerrada** |
