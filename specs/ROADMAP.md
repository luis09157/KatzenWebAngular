...
| **Finanzas / CxC** | **032 done:** ticket unificado por visita (`Katzen/Visitas`) + saldo cliente / cuenta corriente + portal visitas read-only — `specs/032-ticket-visita-saldo-cliente/`. Vacuna→recordatorio auto **deferred**. | Alta — **cerrada (ticket+CxC)** |
