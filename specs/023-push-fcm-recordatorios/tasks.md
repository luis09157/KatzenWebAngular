...
| Deploy function | **BLOCKED** | Firebase exige `RESEND_API_KEY` al analizar codebase (404). Hosting OK 2026-08-26 (6398e6c). Redeploy `onRecordatorioWritePush` cuando Luis setee Resend. |
