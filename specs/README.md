...
├── 052-vacunas-esquemas-push-pwa/      # esquemas vacunación por especie + push + PWA (ola 1 in_progress)
...
| 052 | Vacunas: esquemas por especie + push anti-spam + PWA | **in_progress** (ola 1 motor + confirmación; olas 2–3 pendientes) |
