...
|------|--------|---------------|-----|
| **A** | KPIs valuación + baño defaults/caja + card Finanzas (+ venta→caja si cabe) | SC-INV, SC-005…010, SC-001…004 | Ahora |
| **B** | Consumo historial/cirugía/vacuna + **MVP pensión** (lista/alta/caja) | SC-011…020 | Tras A |
...
**Pensión:** diseño completo en esta spec (Parte 1); código **Fase B** (tras A). Scaffold mínimo solo si A cierra temprano y hay capacidad — no bloquear A.
