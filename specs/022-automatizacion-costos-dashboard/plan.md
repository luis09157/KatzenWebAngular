...
**No implementar pensión completa en Fase A** — sí **scaffold B1** (ruta, lista, alta, precio, menú, rules, cobro caja básico) si A core cierra; defaults pensión + comida = B2/B3.
